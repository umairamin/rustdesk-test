...
class _FileManagerPageState extends State<FileManagerPage>
  ...
  void initState() {
    ...
    print("File manager page init success with id ${widget.id}");
...
class _FileManagerViewState extends State<FileManagerView> {
  ...
  Widget _buildFileList(
    ...
    return ListSearchActionListener(
      ...
      onNext: (buffer) {
        print("searching next for $buffer");
        ...
        if (searchResult.isEmpty) {
          ...
          print("restart search from head");
  ...
  void _jumpToEntry(bool isLocal, Entry entry,
    ...
    if (index == -1) {
      print("entry is not valid: ${entry.path}");
    }
    final selectedEntries = selectedItems;
    ...
    print("focused on ${searchResult.first.name}");
  }
                  ...
                  onTap: () async {
                    ...
                    if (isPeerWindows) {
                      ...
                      try {
                        ...
                        print("buildBread fetchDirectory err=$e");
                      } finally {
                        if (!isLocal) {
